...
class TrustCertificate(FPDF):
    def header(self):
        ...
        self.cell(0, 10, "Cryptographically Secured Provenance | PramanaChain v1.5.0", align="C", new_x="LMARGIN", new_y="NEXT")
    ...
    def footer(self):
        ...
        self.cell(0, 10, f"Verified by PramanaChain Immutable Ledger | Page {self.page_no()}", align="C")
