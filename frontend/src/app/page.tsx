      ...
      <section className="py-12 border-b border-white/5 bg-slate-900/30 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center items-center gap-6 mt-10">
            ...
            <span className="text-[10px] text-slate-500 border border-slate-800 rounded-sm px-2 py-1 bg-slate-900">SECURITY-FIRST DESIGN (ENCRYPTION AT REST, SIGNED AUDIT TRAIL)</span>
          </div>
        </div>
      </section>
